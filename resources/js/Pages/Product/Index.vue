                ...
                <div class="flex gap-2 items-center justify-between py-4">
                    <div class="flex gap-2">
                        ...
                        <div v-for="filter in filter_toolbar" :key="filter.title">
                            <Filter :column="table.getColumn(filter.column)" :title="filter.title"
                                :options="filter.data">
                            </Filter>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-5 ">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="grid gap-2">
                                    ...
                                    <span v-if="errors?.category_ref_id" class="text-red-600 text-sm">{{
                                        errors.category_ref_id
                                        }}</span>
                                ...
                                <div class="grid gap-2">
                                    ...
                                    <span v-if="errors?.brand_ref_id" class="text-red-600 text-sm">{{
                                        errors.brand_ref_id
                                        }}</span>
                                </div>
                            ...
                            <div class="flex flex-col gap-2">
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <div v-for="img in imageUrl" :key="img.id">
                                            <img alt="Product image"
                                                class="aspect-square w-full rounded-md object-cover" height="45"
                                                :src="img" width="45" />
                                        </div>
                                ...
                                <div class="flex  items-center gap-2 pt-5">
                                    <Label for="is_active" @click="form.is_active = !form.is_active"
